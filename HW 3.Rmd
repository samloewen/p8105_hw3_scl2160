...
accel_plot
```
 This chart appears to show that activity spikes in the middle of the day, as is to be expected given typical sleep schedules. This person appears to be slightly more active over the weekends, but they appeared to have one very active weekend that may be skewing the results. Similarly this person had one very inactive Friday-Saturday that seem like outliers among their typical activity pattern.
